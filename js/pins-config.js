var pins_config = {
  "pins":[
  {
    ...
    "hover": "<b><u>IPOH</u></b><br>Write any text and load images<br><img src='example.png'>",//info of the popup
    "pos_X": 76,//check the X, Y coordinates guide in the documentation
    "pos_Y": 125,
  ...
  {
    "shape": "circle",
    "hover": "<b><u>SHAH ALAM</u></b><br><span style='color: #bcbcbc;'>Street Address:</span><br>&nbsp;321 Example, Address 54321<br><span style='color: #bcbcbc;'>Telephone:</span><br>&nbsp;(256) 555-4321 / (256) 555-1234",
    "pos_X": 92,
    "pos_Y": 193,
    "size": 0,
    "outline": "#660000",
  ...
  {
    "shape": "circle",
    "hover": "<b><u>ISKANDAR PUTERI</u></b><br><span style='color: #999;'>Click to open a modal window!</span><br><span style='color: #ff6666;'><b>Modal Window Option is Compatible<br> with Bootstrap Only.</b></span>",
    "pos_X": 191,
    "pos_Y": 271,
    "size": 0,
    "outline": "#660000",
  ...
  {
    "shape": "circle",
    "hover": "<b><u>KOTA KINABALU</u></b><br><span style='color: #999;'>*Click to open a webpage*</span>",
    "pos_X": 605,
    "pos_Y": 67,
    "size": 0,
    "outline": "#660000",
...
jQuery(function () {
  ...
  if(pins_len > 0) {
    ...
    var tsvg_obj = document.getElementById("myjspins");
    ...
    for (var i = 0; i < pins_len; i++) {
      if (pins_config.pins[i].shape === "circle") {
        ...
        svg_circle.setAttributeNS(null, "id", "myjspins_" + i);
        tsvg_obj.appendChild(svg_circle);
        myjsAddEvent(i);
      }
        ...
        svg_rect.setAttributeNS(null, "id", "myjspins_" + i);
        tsvg_obj.appendChild(svg_rect);
        myjsAddEvent(i);
      }
    }
...
function myjsAddEvent(id) {
  var obj = jQuery("#myjspins_" + id);
  if(pins_config.pins[id].active === true){
    obj.attr({"cursor": "pointer"});
    obj.hover(function () {
      jQuery("#myjstip").show().html(pins_config.pins[id].hover);
